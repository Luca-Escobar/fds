const settings = {
    token: "MTI4MDE0MzMwMjM4OTEzNzQzOQ.GKUQnC.nR_BPBjLHmVfPlnlHeCLemRQa9bn6-7nMvf4ro", // Bot Token
    guildid: "1273625411624112199", // Guild ID
    activity: "NERO TEAM", // Activity Message
    activitytype: "WATCHING", // WATCHING, LISTENING, PLAYING, STREAMING
    staffId: "1273880615485313044", // Staff Role ID
...
const categorys = [
    // To add more categorys, just copy the code below and paste it above the last category.
    {
        ...
        emoji: "❔",
        categoryid: "1273915482600378489",
        ticket: {
            name: "sup-{username}",
            topic: "{userid}",
            pinguser: true,
            pingstaff: false, // false to disable
            perms: "1273880648435761233",
            emebd: {
